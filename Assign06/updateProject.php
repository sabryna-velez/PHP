        ...
        <ul>
            <li><label title="ProjectID" for="projectIDdis">Project ID</label>
							<input name="projectIDdis" id="projectIDdis" type="text" size="20" maxlength="3"
							 ...
							 <input name="projectID" id="projectID" type="hidden" size="20" maxlength="3"
 										 value="<?php if($num_results != 0) {echo( trim($row["ProjectID"]) );} ?>"/>
						</li>
						<li><label title="ProjName" for="projName">Project Name</label>
							<input name="projName" id="projName" type="text" size="20" maxlength="50"
										 value="<?php if($num_results != 0) {echo( trim($row["ProjName"]) );} ?>"/></li>
