...
<head>
	...
	<style type="text/css">
		...
		ul li input[type="radio"]{float: none; margin-right:0; padding: 0px; width: 40px;}
...
<form id="form0" method="post" action="doUpdateCar.php">
	<fieldset>
        ...
        <ul>
            ...
            <li><label title="CarModel" for="carModel">Model</label><input name="carModel" id="carModel" type="text" size="20" maxlength="20"
							value="<?php if($num_results != 0) {echo(trim($row["CarModel"]));} ?>"/></li>
			...
			<li><label title="CarColor" for="carColor">Color</label><input name="carColor" id="carColor" type="text" size="20" maxlength="20"
