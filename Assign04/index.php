<?php
session_start(); //starts session, allows me to use session variables
?>
<!DOCTYPE html>
<html>
<head>
	...
	<style type="text/css">
		...
		div#errorMsg {color: #ff0000; font-weight:bold; font-sixe:12pt; position:absolute; top:420px; left:480px;}
	</style>
</head>
<body>
    ...
    <fieldset id="billing">
        ...
        <ul>
            ...
            <li> 
				...
				<textarea rows="5" cols="40" name="comments" id="comments"><?php 
					if( !empty($_SESSION["comments"])){echo($_SESSION["comments"]);} ?></textarea>
			</li>
