...
<title>Assign02 - Login</title>
	<style type="text/css">
		...
		ul li input {float: right; margin-right: 10px; border: 1px solid #ccc; padding: 3px; font-family: Gotham, "Helvetica Neue", Helvetica, Arial, "sans-serif"; width: 60%;}
...
<body>
	<h1 style="font-size: 14pt; text-indent:360px">Assign 02 - Login</h1>
	...
	<form id="form0" name="form0" action="login.php" method="post">
		...
		<fieldset id="submit"> 
			<input type="submit" id="SubmitBtn" name="SumbitBtn" value="Login" />
		</fieldset>
	</form>
